...
# Generar texto usando el prompt proporcionado y controlando la longitud del texto generado
result = pipe(args.prompt, max_new_tokens=50)  # Controlar la longitud con max_new_tokens
